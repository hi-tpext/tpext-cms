...
return [
    ...
    '__config__' => [
        ...
        'click_make_static' => ['type' => 'number', 'label' => '自动成静态', 'help' => '内容页开启静态生成时，设置每n次点击后重新生成静态（在重新生成之前，点击量不会更新）。'],
        'click_write' => ['type' => 'number', 'label' => '点击量写入', 'help' => '点击量存在于缓存中，设置每n次点击后写入数据库一次。'],
